window.resumeI18n = {
    en: {
      ...
      epBullets: [
        ...
        "<strong>Cut recurring cloud costs — measurably — and gave the company's data its first safety net.</strong> Moved the warehouse and its scheduling off two paid monthly cloud services onto self-run infrastructure in a single quarter with zero dashboard downtime. Checked against the actual Azure bill: <strong>the Data Factory line went to zero the day after retirement</strong> and <strong>the warehouse's cloud database was shut down for good</strong>. The bigger win was runtime — <strong>the nightly batch went from 2 hours to 20 minutes</strong>. The decision came from measurement, not instinct: the batch was pinned at 98% IO in the cloud, and scaling vCores was tested and measured to cost more without paying for itself. Also shipped the first nightly, independently verified backup the warehouse ever had. I design, build, deploy and stay on call for <strong>all 7 production systems</strong>."
      ],
      travelerRoles: [
    ...
    th: {
      ...
      epBullets: [
        ...
        "<strong>ลดค่าใช้จ่ายคลาวด์รายเดือนแบบวัดผลได้ และทำให้ข้อมูลบริษัทมีที่สำรองเป็นครั้งแรก</strong> — ย้าย warehouse และระบบตั้งเวลางานออกจากบริการคลาวด์รายเดือน 2 ตัว มาอยู่บนเครื่องที่ดูแลเอง จบในไตรมาสเดียวโดย dashboard ไม่ดาวน์เลย · ตรวจกับบิล Azure จริง: <strong>ค่า Data Factory เหลือ 0 ตั้งแต่วันถัดจากวันปลดระวาง</strong> และ <strong>ฐานข้อมูลคลาวด์ของคลังถูกปิดถาวรได้สำเร็จ</strong> · ผลที่ใหญ่กว่าค่าใช้จ่ายคือ <strong>nightly batch จาก 2 ชม. เหลือ 20 นาที</strong> — การตัดสินใจย้ายมาจากการวัด ไม่ใช่ความรู้สึก: batch เดิมติด IO 98% บนคลาวด์ และการเพิ่ม vCore ทดสอบแล้ววัดได้ว่าแพงขึ้นโดยไม่คุ้มจนต้องถอยกลับ · ทำ backup รายคืนตัวแรกของ warehouse พร้อมตรวจสอบผลทุกครั้ง · <strong>ดูแลระบบ production ทั้ง 7 ตัว</strong> ตั้งแต่ออกแบบ สร้าง deploy จนถึง on-call"
      ],
      travelerRoles: [
        "Accounting · ERP &amp; BI · Operations (multiple hats)"
      ],
