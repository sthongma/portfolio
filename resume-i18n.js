window.resumeI18n = {
    ...
    th: {
      ...
      epBullets: [
        ...
        "<strong>จับปัญหาข้อมูลที่ไม่มีใครรู้ว่ากำลังเกิด แล้วแก้ให้จบที่ราก</strong> — กู้เลขพัสดุคืน <strong>23,677 เลข</strong> ที่ระบบลบทิ้งไปเงียบ ๆ และไล่จนเจอสาเหตุที่ <strong>28.5% ของยอดขายเดือนหนึ่ง (฿37.9 ล้าน จาก ฿132.8 ล้าน) ไม่ติดชื่อร้าน — ตอนนี้เหลือศูนย์</strong> พร้อมวางระบบตรวจอัตโนมัติที่เตือนก่อนตัวเลขผิดจะไปถึงการตัดสินใจ (data-reliability tests, freshness monitoring)",
        "<strong>เปลี่ยนปัญหาที่เคย “รู้ตอนสายไปแล้ว” ให้ดักได้ล่วงหน้า</strong> — ระบบเทียบราคาขายจริงกับเพดานราคา/ส่วนลดราย SKU × ร้าน: ย้อนตรวจทั้งประวัติการขายดักได้ <strong>150 คู่ SKU×ร้าน · ส่วนลดที่ให้เกินเพดานที่ตั้งไว้เอง ฿331,460</strong> · และ reorder engine บน dashboard (จุดสั่งซ้ำ, safety stock, days-of-cover, ปริมาณที่ควรสั่ง) แทนการเปิดหลายตารางมานั่งเทียบเอง — ครอบ <strong>2,971 SKU ชี้ 373 ตัวที่ต้องสั่งทันที</strong> และจับ PO ค้างที่ระบบเคยนับผิดว่าเป็นของกำลังมา",
        "<strong>เปลี่ยนระบบคลังของ vendor เป็นแอปที่เขียนเอง และปิดช่องว่างที่ ERP ทำไม่ได้</strong> — WMS: จากโค้ดบรรทัดแรกถึง production deploy ใน <strong>15 วัน</strong> · พนักงาน (รวมคนไม่ใช้ภาษาไทย) เรียนไม่ถึง 5 นาทีก็ใช้ได้ ทุกการหยิบ/นับ/ย้ายลง inventory ledger พร้อม audit trail — ปัจจุบัน <strong>208,189 รายการ · ผู้ใช้จริง 36 คน</strong> รองรับ ~2,000 ออเดอร์/วัน · ระบบสแกน barcode ปิด 2 ช่องว่างของ ERP: แยก <strong>“เคลม” ออกจาก “คืนปกติ” ได้ 21,152 พัสดุ</strong> และตอบได้ว่าของกลับถึงคลังหรือยัง (การมองเห็นขากลับ 26.8% → 98.0%) — เห็นของกำลังเดินทางกลับมูลค่า <strong>฿7.9 ล้าน</strong> ที่เดิมมองไม่เห็น",
